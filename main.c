...
/*   Updated: 2019/10/31 14:23:04 by vkurkela         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	list1 = ft_lstnew(content, content_size);
	...
	list8 = ft_lstnew(content, content_size);
	
	printf("Head is before EXPEXTED (Head): %s\n", list1->content);
	ft_lstadd(&list1, list8);
	...
	*/
	...
	ft_lstiter(list8, &print_content);
